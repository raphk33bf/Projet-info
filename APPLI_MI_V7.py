...
#-------------Partie trajet-------------------------------------
    ...
    def ajout_trajet_journee(self, instance):
        ...
        self.horaire_debut = TextInput(text="25/06/2026 11:49")
        self.layout.add_widget(self.horaire_debut)
        self.horaire_fin = TextInput(text="25/06/2026 11:50")
    ...
    def on_horaire(self, requete, resultat):
        ...
        for i in range (len(self.liste_moyens_estimes_h)):
            ...
            UrlRequest(url='http://irioso.free.fr/Ambrasobin/insert_sous_trajet_detecte', req_body=json.dumps(data),  req_headers=headers, on_success=self.on_success)
    ...
    def envoi_moy_h(self, instance):
        ...
        for i in range(len(self.liste_moyens_estimes_h)):
            ...
            self.label = Label(text=self.liste_moyens_estimes_h[i] + " pendant " + str(self.secondes_en_hms(int(self.duree_h))) + " secondes\n")
            self.layout.add_widget(self.label)
